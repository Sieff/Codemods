...
//const { modifiedBody, returnStatementCount } = replaceParamsWithArguments(j, ast, functions[idx], functionParams, callerArguments);
// if (modifiedBody && returnStatementCount === 1) {
//     return modifiedBody.get(0).node.body[0].argument;
// }